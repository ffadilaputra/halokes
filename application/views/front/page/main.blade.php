    ...
    <div class="clients-area">
      <div class="container">
        <div class="owl-carousel owl-theme" id="client">
          <div class="item">
            <a href="#">
              <img src="{{ base_url('assets/browny') }}/assets/images/clients/c1.png" alt="brand-image" />
            </a>
          </div>
          <!--/.item-->
          <div class="item">
            <a href="#">
              <img src="{{ base_url('assets/browny') }}/assets/images/clients/c2.png" alt="brand-image" />
            </a>
          </div>
          <!--/.item-->
          <div class="item">
            <a href="#">
              <img src="{{ base_url('assets/browny') }}/assets/images/clients/c3.png" alt="brand-image" />
            </a>
          </div>
          <!--/.item-->
          <div class="item">
            <a href="#">
              <img src="{{ base_url('assets/browny') }}/assets/images/clients/c4.png" alt="brand-image" />
            </a>
          </div>
          <!--/.item-->
          <div class="item">
            <a href="#">
              <img src="{{ base_url('assets/browny') }}/assets/images/clients/c5.png" alt="brand-image" />
            </a>
          </div>
          <!--/.item-->
          <div class="item">
            <a href="#">
              <img src="{{ base_url('assets/browny') }}/assets/images/clients/c6.png" alt="brand-image" />
            </a>
          </div>
          <!--/.item-->
          <div class="item">
            <a href="#">
              <img src="{{ base_url('assets/browny') }}/assets/images/clients/c7.png" alt="brand-image" />
            </a>
          </div>
          <!--/.item-->
        </div>
