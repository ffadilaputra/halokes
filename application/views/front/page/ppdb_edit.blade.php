                        ...
                        <div class="row">
                           ...
                           <div class="col-md-12 col-lg-6 main-content">
                              ...
                              <div class="form-group">
                                 ...
                                 <option @if(old('hobi') == 'lainnya') selected @endif value="Lainnya">lainnya</option>
                                 </select>
                              </div>
                              <div class="form-group">
                                 ...
                                 <select class="form-control" name="cita_cita" id="citacita" value="{{ old('cita_cita') }}" required>
                                    ...
                                    <option @if(old('cita_cita') == 'tnipolri') selected @endif value="tnipolri">TNI/Polri</option>
                                    <option @if(old('cita_cita') == 'politikus') selected @endif value="politikus">Politikus</option>
                                    <option @if(old('cita_cita') == 'guru') selected @endif value="guru">guru/dosen</option>
                                    <option @if(old('cita_cita') == 'wiraswasta') selected @endif value="wiraswasta">wiraswasta</option>
                                    <option @if(old('cita_cita') == 'lainnya') selected @endif value="lainnya">lainnya</option>
                                 </select>
                              </div>
                              <div class="form-group">
                                 ...
                                 <option @if(old('keb_khusus') == 'tunaLaras') selected @endif value="tunaLaras">Tuna Laras</option>
                                 <option @if(old('keb_khusus') == 'tunaDaksa') selected @endif value="tunaDaksa">Tuna Daksa</option>
                                 <option @if(old('keb_khusus') == 'sulitBelajar') selected @endif value="sulitBelajar">sulitBelajar</option>
                                 <option @if(old('keb_khusus') == 'gangguanKomunikasi') selected @endif value="gangguanKomunikasi">Gangguan Komunikasi</option>
                                 <option @if(old('keb_khusus') == 'lambanBelajar') selected @endif value="lambanBelajar">Lamban Belajar</option>
                                 <option @if(old('keb_khusus') == 'bakatLuarBiasa') selected @endif value="bakatLuarBiasa">Bakat Luar Biasa</option>
                                 </select>
                              </div>
                           </div>
                        </div>
                        ...
                        <div class="row">
                           ...
                           <div class="col-md-12 col-lg-6 main-content">
                              ...
                              <div class="form-group">
                                 ...
                                 <option @if(old('jenis_sekolah_siswa') == 'sma/smk') selected @endif value="sma/smk">SMA/K</option>
                                 ...
                                 <option @if(old('jenis_sekolah_siswa') == 'paketC') selected @endif value="paketC">paket C</option>
                                 </select>
                              </div>
                              <div class="form-group">
                        ...
                        <div class="row">
                           ...
                           <div class="col-md-12 col-lg-6 main-content">
                              ...
                              <div class="form-group">
                                 ...
                                 <option @if(old('pendidikan_terakhir_ayah') == 'SMA/MA/SLTA/SMK') selected @endif value="SMA/MA/SLTA/SMK">SMA/MA/SLTA/SMK</option>
                           ...
                           <div class="col-md-12 col-lg-6 main-content">
                              ...
                              <div class="form-group">
                                 ...
                                 <option @if(old('pendidikan_terakhir_ibu') == 'SMA/MA/SLTA/SMK') selected @endif value="SMA/MA/SLTA/SMK">SMA/MA/SLTA/SMK</option>
                        ...
                        <div class="col-md-12 col-lg-6 main-content">
                           ...
                           <div class="form-group">
                              ...
                              <select class="form-control" name="pendidikan_terakhir_wali" id="" value="{{ old('pendidikan_terakhir_wali') }}">
                                 <option @if(old('pendidikan_terakhir_wali') == 'SD/MI') selected @endif value="SD/MI">SD/MI</option>
                                 <option @if(old('pendidikan_terakhir_wali') == 'SMP/MTs/SLTP') selected @endif value="SMP/MTs/SLTP">SMP/MTs/SLTP</option>
                                 <option @if(old('pendidikan_terakhir_wali') == 'SMA/MA/SLTA/SMK') selected @endif value="SMA/MA/SLTA/SMK">SMA/MA/SLTA/SMK</option>
