   ...
   <div class="container">
      <div class="row mb-5">
         <div class="col-md-4">
            <h3>About Us</h3>
            <p class="mb-4">
               <img src="{{ base_url('assets/wordify') }}/images/img_1.jpg" alt="Image placeholder" class="img-fluid">
            </p>
                     ...
                     <ul>
                        ...
                        <li>
                           <a href="">
                              ...
                              <img src="{{ base_url('assets/wordify') }}/images/img_3.jpg" alt="Image placeholder" class="mr-4">
                              <div class="text">
                                 <h4>How to Find the Video Games of Your Youth</h4>
                                 <div class="post-meta">
                                    <span class="mr-2">March 15, 2018 </span> &bullet;
