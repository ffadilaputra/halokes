<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
  ...
  <div class="collapse navbar-collapse navbar-ex1-collapse">
    <ul class="nav navbar-nav side-nav">
      ...
      <li>
        <a href="{{ base_url('admin/berkas') }}"><i class="fa fa-fw fa-book"></i>PPDB Santri Baru</a>
      </li>
      @endif
      <!-- santri -->
      @if($admin->id_level == 10 || $admin->id_level == 12 || $admin->id_level == 16)
      <li>
        <a href="{{ base_url('admin/santri/all') }}"><i class="fa fa-fw fa-user"></i>Santri</a>
      </li>
      @endif
      <!-- artikel -->
...
<li>
  ...
  <ul id="master" class="collapse">
    ...
    <li><a href="{{ base_url('admin/user/operator') }}">Akun Admin / Operator</a></li>
...
<li>
  <a href="{{ base_url('admin/user') }}"><i class="fa fa-fw fa-users"></i>Pegawai</a>
</li>
<li>
  <a href="{{ base_url('admin/santri/alumni') }}"><i class="fa fa-fw fa-user"></i>Alumni</a>
</li>
@endif
</ul>
</a>
