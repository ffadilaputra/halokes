                  ...
                  <form action="#" class="p-5 bg-light">
                        ...
                        <div class="row">
                           ...
                           <div class="col-md-12 col-lg-6 main-content">
                              ...
                              <div class="form-group">
                                 ...
                                 <input name="nama_ayah_siswa" type="text" class="form-control" id="namaAyah" value="<?php echo e(old('nama_ayah_siswa')); ?>" required>
                              ...
                              <div class="form-group">
                                 ...
                                 <input name="napang_ayah_siswa" type="text" class="form-control" id="panggilanAyah" value="<?php echo e(old('napang_ayah_siswa')); ?>" required>
                              ...
                              <div class="form-group">
                                 ...
                                 <input name="nik_ayah_siswa" type="number" class="form-control" id="nikAyah" value="<?php echo e(old('nik_ayah_siswa')); ?>" required>
                              ...
                              <div class="form-group">
                                 ...
                                 <input name="alamat_ayah" type="text" class="form-control" id="alamat" value="<?php echo e(old('alamat_ayah')); ?>" required>
                              ...
                              <div class="form-group">
                                 ...
                                 <input name="kabkota_ayah" type="text" class="form-control" id="kabkota" value="<?php echo e(old('kabkota_ayah')); ?>" required>
                              ...
                              <div class="form-group">
                                 ...
                                 <input name="provinsi_ayah" type="text" class="form-control" id="prov" value="<?php echo e(old('provinsi_ayah')); ?>" required>
                              ...
                              <div class="form-group">
                                 ...
                                 <input name="kodepos_ayah" type="number" class="form-control" id="kodepos" value="<?php echo e(old('kodepos_ayah')); ?>" required>
                           ...
                           <div class="col-md-12 col-lg-6 main-content">
                              ...
                              <div class="form-group">
                                 ...
                                 <input name="nama_ibu_siswa" type="text" class="form-control" id="namaIbu" value="<?php echo e(old('nama_ibu_siswa')); ?>" required>
                              ...
                              <div class="form-group">
                                 ...
                                 <input name="napang_ibu_siswa" type="text" class="form-control" id="panggilanIbu" value="<?php echo e(old('napang_ibu_siswa')); ?>" required>
                              ...
                              <div class="form-group">
                                 ...
                                 <input name="nik_ibu_siswa" type="number" class="form-control" id="nikIbu" value="<?php echo e(old('nik_ibu_siswa')); ?>" required>
                     ...
                     <div>
                        <div class="row">
                              ...
                              <div class="form-group">
                                    <label for="namaAyah">Nama Lengkap</label>&nbsp;<label style="color:red">(wajib di isi)</label>
                                    <input name="nama_wali_siswa" type="text" class="form-control" id="namawali" value="<?php echo e(old('nama_wali_siswa')); ?>" required>
                              ...
                              <div class="row">
                                    ...
                                    <div class="form-group">
                                          <label for="">Tahun</label>
                                          <input name="tahun_wali"  type="number" min="1930" max="2018" class="form-control medqInput" id="tahun" onkeyup="capt()" value="<?php echo e(old('tahun_wali')); ?>">
