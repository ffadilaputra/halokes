...
<script src="<?php echo e(base_url('assets/wordify')); ?>/js/jquery-3.2.1.min.js"></script>
<script src="<?php echo e(base_url('assets/wordify')); ?>/js/popper.min.js"></script>
<script src="<?php echo e(base_url('assets/wordify')); ?>/js/bootstrap.min.js"></script>
<script src="<?php echo e(base_url('assets/wordify')); ?>/js/owl.carousel.min.js"></script>
<script src="<?php echo e(base_url('assets/wordify')); ?>/js/jquery.waypoints.min.js"></script>
<script src="<?php echo e(base_url('assets/wordify')); ?>/js/jquery.stellar.min.js"></script>
<script src="<?php echo e(base_url('assets/wordify')); ?>/js/jquery-migrate-3.0.0.js"></script>
