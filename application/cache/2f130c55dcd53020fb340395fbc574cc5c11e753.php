            ...
            <table id="main" class="table table-bordered table-hover table-striped">
               ...
               <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      <a class="btn btn-info" href="<?php echo e(base_url('admin/santri/show/').$data->id_santri); ?>"><i class="fa fa-eye"></i>&nbsp;Detail</a>
                      <a class="btn btn-success" href="<?php echo e(base_url('admin/verify/show/').$data->id_santri); ?>"><i class="fa fa-check-square-o" aria-hidden="true"></i> Verify</a>
                    </td>
                  </tr>
