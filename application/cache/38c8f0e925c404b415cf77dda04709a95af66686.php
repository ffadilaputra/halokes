    ...
    <div class="row">
      <div class="col-md-12 text-center">
        <div class="header-image">
          <img src="<?php echo e(base_url('assets/browny')); ?>/assets/images/main.jpg" alt="Cover">
        </div>
        <!--/.header-text-->
      </div>
      <!--/.col-->
...
<section class="about">
  ...
  <div class="container">
    ...
    <br><br>
    <div class="row">
      <div class="format-text col-sm-5">
        <p>
        ...
        <p>
          Untuk tujuan itulah Yayasan Mahad Darun Najah as-Salafy Pondok Pesantren Salafiyah PPAI Darun Najah mulai mengembangkan pendidikan formal untuk membekali santri kemampuan intelektual dengan didirikannya Madrasah Tsanawiyah formal pada tahun 2011, Pendidikan Layanan Khusus pada tahun 2012 dan Madrasah Aliyah formal pada tahun 2013.
        </p>
      </div>
      <div class="col-sm-offset-1 col-sm-5">
        <br>
        <div class="single-about-img">
          <img src="<?php echo e(base_url('assets/browny')); ?>/assets/images/about/profile_image.jpg" alt="profile_image">
        </div>
      </div>
    </div>
    <div class="row">
