            ...
            <table id="main" class="table table-bordered table-hover table-striped">
               ...
               <tbody>
                  ...
                  <tr>
                     ...
                     <td>
                        <a class="btn btn-success" href="<?php echo e(base_url('admin/berita/show/').$data->id_news); ?>"><i class="fa fa-eye"></i></a>
                        <a class="btn btn-primary" href="<?php echo e(base_url('admin/berita/edit/').$data->id_news); ?>"><i class="fa fa-pencil"></i></a>
                        <a class="btn btn-danger" href="<?php echo e(base_url('admin/berita/delete/').$data->id_news); ?>"><i class="fa fa-trash"></i></a>
                     </td>
                  </tr>
