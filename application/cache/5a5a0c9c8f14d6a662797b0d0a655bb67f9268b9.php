            ...
            <select name="id_news_category" class="form-control">
                <option value="">-- Pilih --</option>
                    <?php $__currentLoopData = $category; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option <?php if($item->id_news_category == $edit->id_news_category): ?> <?php echo 'selected'; ?>  <?php endif; ?> value="<?php echo e($item->id_news_category); ?>"><?php echo e($item->category_name); ?></option>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </select>
        </div>
        <div class="form-group">
            <label for="">Dekripsi </label>
            <textarea id="desc" name="description"><?php echo $edit->description; ?></textarea>
        </div>
        <div class="form-group">
