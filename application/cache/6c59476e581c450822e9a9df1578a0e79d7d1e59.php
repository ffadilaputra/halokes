            ...
            <li>
                <a href="javascript:;" data-toggle="collapse" data-target="#pengumuman"><i class="fa fa-fw fa-book"></i>Artikel <i class="fa fa-fw fa-caret-down"></i></a>
                    <ul id="pengumuman" class="collapse">
                        ...
                        <li><a href="<?php echo e(base_url('admin/kategoriberita')); ?>">Kategori Berita</a></li>
                        <li><a href="<?php echo e(base_url('admin/berita')); ?>">Semua Berita</a></li>
                        <li><a href="<?php echo e(base_url('admin/mauidhoh')); ?>">Mauidhoh</a></li>
                    </ul>
                </a>
            </li>
            <li>
                    <a href="javascript:;" data-toggle="collapse" data-target="#master"><i class="fa fa-fw fa-archive"></i>Master <i class="fa fa-fw fa-caret-down"></i></a>
                        <ul id="master" class="collapse">
                            <li><a href="<?php echo e(base_url('admin/level')); ?>">Level</a></li>
                            <li><a href="<?php echo e(base_url('admin/pendidikan')); ?>">Pendidikan</a></li>
                            <li><a href="<?php echo e(base_url('admin/provesi')); ?>">Provesi</a></li>
                        </ul>
                    </a>
                </li>
        </ul>
